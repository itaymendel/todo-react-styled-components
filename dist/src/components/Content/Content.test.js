...
describe('Content', function () {
  ...
  it('should show a todo items list', function () {
    ...
    // Initial render
    expect(component.find('.content__todos').first().children()).toHaveLength(0);
    ...
    props.items = [].concat(_toConsumableArray(props.items), [(0, _enzyme.shallow)(_react2.default.createElement(_FormItem2.default, Object.assign({}, props, { item: item })))]);
