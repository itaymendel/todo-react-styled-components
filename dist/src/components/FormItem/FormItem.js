  ...
  function FormItem() {
    ...
    return (
      (_ret = ((_temp = ((_this = _possibleConstructorReturn(
        this,
        (_ref = FormItem.__proto__ || Object.getPrototypeOf(FormItem)).call.apply(_ref, [this].concat(args)),
      )),
      _this)),
      (_this.state = { displayMenu: false }),
      (_this.setDisplayMenu = function(bool) {
      ...
      value: function render() {
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement('span', null, this.props.item.value),
          ),
